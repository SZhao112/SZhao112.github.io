        ...
        <Col className="text-center" style={{ color: 'black' }}>
          ...
          <Form>
            <Form.Group controlId="formPickColor">
              <Form.Label style={{ fontSize: '1.5em' }}>Pick a Color</Form.Label>
              <div>
            ...
            <div className="filters mt-3">
              ...
              <Form.Group controlId="formEcoFriendly" className="d-inline-block mx-3">
                <Form.Check type="checkbox" label="Eco-Friendly" onChange={(e) => setIsEcoFriendly(e.target.checked)} />
              </Form.Group>
              ...
              <Button variant="primary" onClick={handleFilterChange} className="d-inline-block mx-3">Filter</Button>
            </div>
          </Form>
        </Col>
      </Row>
          ...
          <Col md={3} key={index} className="mb-4">
            <div className={`card h-100 ${selectedCard === index ? 'selected' : ''}`} onClick={() => setSelectedCard(index)}>
              ...
              <div className="card-body d-flex flex-column">
                <h5 className="card-title">{color.type}</h5>
                <p className="card-text">Price: ${color.price}</p>
                <p className="card-text">Company: {color.company}</p>
                <p className="card-text">{color.ecoFriendly ? 'Eco-Friendly' : 'Not Eco-Friendly'}</p>
              </div>
            </div>
          </Col>
        ))}
